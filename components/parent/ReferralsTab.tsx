  ...
  if (!data) {
    return (
      <div className="space-y-6">
        ...
        {/* How It Works */}
        <div className="bg-gray-50 rounded-2xl border border-pink-200 p-6">
          <h3 className="font-bold text-gray-900 mb-4">How It Works</h3>
          <div className="grid gap-4">
            <div className="flex items-start gap-4">
              <div className="w-8 h-8 bg-pink-50 text-[#FF0099] rounded-full flex items-center justify-center font-bold flex-shrink-0">
                1
              </div>
              <div>
            ...
            <div className="flex items-start gap-4">
              <div className="w-8 h-8 bg-purple-50 text-purple-700 rounded-full flex items-center justify-center font-bold flex-shrink-0">
                2
              </div>
              <div>
            ...
            <div className="flex items-start gap-4">
              <div className="w-8 h-8 bg-emerald-50 text-emerald-700 rounded-full flex items-center justify-center font-bold flex-shrink-0">
                3
              </div>
              <div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-[#ff0099]/10 to-[#7b008b]/10 rounded-2xl p-6 border border-[#ff0099]/20">
        ...
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl font-medium text-gray-600 hover:bg-gray-100 transition-all"
          >
        ...
        <button
          ...
          className="w-full mt-2 flex items-center justify-center gap-2 px-4 py-2 text-[#ff0099] text-sm font-medium hover:bg-pink-50 rounded-lg transition-all"
        >
      ...
      <div className="grid grid-cols-2 gap-4">
        {/* Credit Balance */}
        <div className="bg-gray-50 rounded-xl border border-pink-200 p-4">
          <div className="flex items-center gap-2 text-emerald-700 mb-2">
            <IndianRupee className="w-4 h-4" />
            <span className="text-sm font-medium">Credit Balance</span>
          </div>
          <p className="text-2xl font-bold text-gray-900">{formatCredit(data.creditBalance)}</p>
          {data.creditExpiry && (
      ...
      {data.totalEarned > 0 && (
        <div className="bg-emerald-50 rounded-xl border border-emerald-200 p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-emerald-700 font-medium">Total Earned</p>
              <p className="text-3xl font-bold text-emerald-700">{formatCredit(data.totalEarned)}</p>
            </div>
      ...
      {/* How to Use Credit */}
      <div className="bg-gray-50 rounded-xl border border-pink-200 p-6">
        <h3 className="font-bold text-gray-900 mb-4 flex items-center gap-2">
          <Sparkles className="w-5 h-5 text-[#ff0099]" />
          Use Your Credit
        </h3>
        <div className="space-y-3">
          <div className="flex items-center justify-between p-3 bg-white border border-gray-100 shadow-sm rounded-lg">
