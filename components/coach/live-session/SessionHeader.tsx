    ...
    <div className="sticky top-0 z-20 bg-[#1a1f26] border-b border-white/10">
      <div className="px-4 py-3">
        ...
        <div className="flex items-center gap-3">
          {/* Avatar */}
          <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[#00ABFF] to-[#0066CC] flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
