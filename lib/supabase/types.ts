    ...
    Tables: {
      ...
      book_votes: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "book_votes_child_id_fkey"
            columns: ["child_id"]
            isOneToOne: false
            referencedRelation: "children"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "book_votes_parent_id_fkey"
            columns: ["parent_id"]
            isOneToOne: false
            referencedRelation: "parents"
            referencedColumns: ["id"]
      ...
      child_artifacts: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "child_artifacts_enrollment_id_fkey"
          ...
          {
            foreignKeyName: "child_artifacts_revision_of_fkey"
            columns: ["revision_of"]
            isOneToOne: false
            referencedRelation: "child_artifacts"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "child_artifacts_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "scheduled_sessions"
            referencedColumns: ["id"]
      ...
      child_intelligence_profiles: {
        Row: {
          child_id: string
          created_at: string | null
          engagement_pattern: string | null
          freshness_status: string | null
          high_confidence_event_count: number | null
          id: string
          last_any_signal_at: string | null
          last_high_confidence_signal_at: string | null
          last_synthesized_at: string | null
          low_confidence_event_count: number | null
          medium_confidence_event_count: number | null
          modality_coverage: Json | null
          ...
          synthesis_event_ids: string[] | null
      ...
      coach_payouts: {
        Row: {
          ...
          created_at: string | null
          description: string | null
          enrollment_revenue_id: string | null
      ...
      coach_quality_log: {
        Row: {
          ...
          month: string
          platform_hours: number | null
          re_enrollment_rate: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "coach_quality_log_coach_id_fkey"
            columns: ["coach_id"]
            isOneToOne: false
            referencedRelation: "coach_activity_summary"
            referencedColumns: ["id"]
      ...
      coach_scores: {
        Row: {
          ...
          hybrid_eligible: boolean | null
          id: string
          intelligence_score_30d: number | null
          intelligence_score_avg: number | null
          intelligence_score_trend: string | null
          month: string
      ...
      el_learning_units: {
        ...
        Relationships: [
          {
            foreignKeyName: "el_learning_units_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
      ...
      el_modules: {
        ...
        Relationships: [
          {
            foreignKeyName: "el_modules_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
            referencedRelation: "skill_categories"
            referencedColumns: ["id"]
      ...
      el_skill_observations: {
        ...
        Relationships: [
          {
            foreignKeyName: "el_skill_observations_skill_id_fkey"
            columns: ["skill_id"]
            isOneToOne: false
            referencedRelation: "el_skills"
            referencedColumns: ["id"]
      ...
      el_skills: {
        ...
        Relationships: [
          {
            foreignKeyName: "el_skills_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
            referencedRelation: "skill_categories"
            referencedColumns: ["id"]
      ...
      elearning_sessions: {
        ...
        Relationships: [
          {
            foreignKeyName: "elearning_sessions_child_id_fkey"
            columns: ["child_id"]
            isOneToOne: false
            referencedRelation: "children"
            referencedColumns: ["id"]
      ...
      enrollment_revenue: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "enrollment_revenue_referrer_id_fkey"
            columns: ["referrer_id"]
            isOneToOne: false
      ...
      enrollments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "enrollments_original_referrer_id_fkey"
            columns: ["original_referrer_id"]
            isOneToOne: false
            referencedRelation: "referrers"
            referencedColumns: ["id"]
          },
      ...
      micro_assessments: {
        Row: {
          attendance_count_at_trigger: number | null
          audio_duration_seconds: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "micro_assessments_child_id_fkey"
            columns: ["child_id"]
            isOneToOne: false
            referencedRelation: "children"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "micro_assessments_group_session_id_fkey"
            columns: ["group_session_id"]
            isOneToOne: false
            referencedRelation: "group_class_registrations_summary"
            referencedColumns: ["session_id"]
          ...
          {
            foreignKeyName: "micro_assessments_passage_id_fkey"
            columns: ["passage_id"]
            isOneToOne: false
            referencedRelation: "reading_passages"
            referencedColumns: ["id"]
      ...
      referral_conversions: {
        Row: {
          ...
          coaching_bonus_paid_at: string | null
          coaching_bonus_percent_applied: number
          coaching_bonus_status: string | null
          ...
          referrer_payment_reference: string | null
          referrer_payout_method: string | null
          referrer_payout_status: string | null
          referrer_percent_applied: number
          referrer_reward_amount: number
          referrer_upi_id: string | null
        }
        Insert: {
          child_id: string
          coaching_bonus_amount: number
        ...
        Relationships: [
          {
            foreignKeyName: "referral_conversions_child_id_fkey"
            columns: ["child_id"]
            isOneToOne: false
            referencedRelation: "children"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "referral_conversions_coaching_coach_id_fkey"
            columns: ["coaching_coach_id"]
            isOneToOne: false
            referencedRelation: "coach_activity_summary"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "referral_conversions_enrollment_id_fkey"
            columns: ["enrollment_id"]
            isOneToOne: false
            referencedRelation: "enrollments"
            referencedColumns: ["id"]
      ...
      referrers: {
        Row: {
          ...
          custom_referrer_percent: number | null
          email: string | null
          id: string
          is_active: boolean | null
          name: string
          ...
          reward_amount_override: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "referrers_coach_id_fkey"
            columns: ["coach_id"]
            isOneToOne: false
            referencedRelation: "coach_activity_summary"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "referrers_parent_id_fkey"
            columns: ["parent_id"]
            isOneToOne: false
            referencedRelation: "parents"
            referencedColumns: ["id"]
      ...
      scheduled_sessions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "scheduled_sessions_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
            referencedRelation: "skill_categories"
            referencedColumns: ["id"]
      ...
      structured_capture_responses: {
        Row: {
          ...
          child_artifact_text: string | null
          child_artifact_type: string | null
          ...
          skill_performances: Json
          skills_covered: string[]
          strength_observations: string[] | null
        ...
        Relationships: [
          {
            foreignKeyName: "structured_capture_responses_child_id_fkey"
            columns: ["child_id"]
            isOneToOne: false
            referencedRelation: "children"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "structured_capture_responses_coach_id_fkey"
            columns: ["coach_id"]
            isOneToOne: false
            referencedRelation: "coach_activity_summary"
            referencedColumns: ["id"]
      ...
      tuition_onboarding: {
        ...
        Relationships: [
          {
            foreignKeyName: "tuition_onboarding_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
            referencedRelation: "skill_categories"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      hybrid_match_learning_events: {
        Args: {
          ...
          keyword_max_boost?: number
          keyword_weight_multiplier?: number
          match_count?: number
      ...
      increment_referrer_pending: {
        Args: { p_amount: number; p_referrer_id: string }
        Returns: undefined
      }
