...
Powered by *Yestoryd* - AI Reading Coach for Kids 📚`;
  ...
  useEffect(() => {
    if (parentEmail && !emailSent && !sendingEmail) {
      ...
      <header className="bg-white shadow-sm">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            <div className="w-10 h-10 bg-gradient-to-br from-pink-500 to-pink-400 rounded-xl flex items-center justify-center">
              <BookOpen className="w-5 h-5 text-white" />
            </div>
            <span className="text-2xl font-bold">
              <span className="text-pink-500">Yest</span>
              <span className="text-gray-900">or</span>
              <span className="text-yellow-500">yd</span>
            </span>
          </Link>
          <button
