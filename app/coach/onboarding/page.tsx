    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4">
        <div className="bg-surface-1 rounded-2xl p-8 max-w-md text-center">
          ...
          <Link href="/coach/login" className="inline-flex items-center gap-2 px-6 py-3 bg-[#00ABFF] text-white rounded-xl hover:bg-[#00ABFF] transition-colors">
            Go to Login
          </Link>
        </div>
      </div>
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-center gap-4">
            <div className={`flex items-center gap-2 ${currentStep === 'agreement' ? 'text-blue-400' : 'text-green-400'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${
                currentStep === 'agreement' ? 'bg-[#00ABFF] text-white' : 'bg-green-500 text-white'
              }`}>
            ...
            <div className={`flex items-center gap-2 ${currentStep === 'bank_details' ? 'text-blue-400' : currentStep === 'complete' ? 'text-green-400' : 'text-text-tertiary'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${
                currentStep === 'bank_details' ? 'bg-[#00ABFF] text-white' : 
        ...
        <div className="bg-surface-1 rounded-2xl shadow-xl overflow-hidden">
              ...
              <form onSubmit={handleBankSubmit} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 border border-border rounded-xl text-white bg-surface-1 focus:ring-2 focus:ring-[#00ABFF]"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className={`w-full px-4 py-3 border rounded-xl text-white bg-surface-1 focus:ring-2 focus:ring-[#00ABFF] ${
                ...
                <button
                  ...
                  className="w-full py-4 bg-gradient-to-r from-[#00ABFF] to-purple-600 text-white rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {saving ? (
          ...
          {currentStep === 'complete' && (
            <div className="p-6 sm:p-8">
              ...
              {coach.referral_code && (
                <div className="bg-gradient-to-r from-[#00ABFF] to-purple-600 rounded-2xl p-6 mb-6 text-white">
                  ...
                  <div className="bg-surface-1/10 rounded-xl p-3 flex items-center gap-3">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-surface-1 text-[#00ABFF] rounded-lg font-medium text-sm hover:bg-[#00ABFF]/10 transition-colors flex items-center gap-1"
                    >
              ...
              <div className="text-center">
                <button onClick={() => setCurrentStep('bank_details')} className="text-sm text-text-tertiary hover:text-[#00ABFF] transition-colors inline-flex items-center gap-1">
