...
function CheckoutContent() {
  ...
  const amount = parseInt(searchParams.get('amount') || '5999');
  ...
  const orderSummary = {
    ...
    sessions: '9 sessions (6 coaching + 3 parent meetings)',
    coach: 'Coach Rucha',
    child: childName,
    originalPrice: 8999,
    discount: 8999 - amount,
    finalPrice: amount,
  };
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-gray-500 text-sm">Coach: {orderSummary.coach}</p>
                </div>
                <p className="text-gray-400 line-through">₹{orderSummary.originalPrice.toLocaleString()}</p>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-gray-600">
                  <span>Subtotal</span>
                  <span>₹{orderSummary.originalPrice.toLocaleString()}</span>
                </div>
          ...
          >
            {isLoading ? (
              ...
              <>
                ...
                Pay ₹{orderSummary.finalPrice.toLocaleString()}
              </>
            )}
          </button>
