    ...
    <div className="bg-surface-0">
      <div className="bg-surface-1 border-b border-border">
        <div className="px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          <h1 className="text-lg sm:text-xl lg:text-2xl font-bold text-white">Analytics</h1>
          <p className="text-xs sm:text-sm text-text-tertiary mt-0.5 sm:mt-1">Platform insights and performance metrics</p>
        </div>
      </div>
