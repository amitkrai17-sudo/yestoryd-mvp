...
const WA_TEMPLATE_LABELS: Record<string, string> = {
  ...
  parent_tuition_onboarding_v5: 'Onboarding',
  parent_tuition_onboarding_v4: 'Onboarding',
  parent_assessment_results_v4: 'Results',
    ...
    try {
      const res = await fetch('/api/admin/tuition/create', {
        ...
        body: JSON.stringify({
          ...
          schedulePreference: { ...newForm.schedulePref, raw: undefined },
