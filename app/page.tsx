...
async function getHomePageData() {
  try {
    ...
    const content = {
      ...
      rai_generic_ai_description: settings.rai_generic_ai_description as string || 'based on the internet. No reading expertise. No understanding of phonics rules. May give incorrect or generic advice.',
      ...
      rai_safe_ai_description: settings.rai_safe_ai_description as string || "Built on 7+ years of Rucha's phonics expertise. Never guesses — always references proven methods.",
