          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="inline-flex items-center gap-2 bg-[#ffde00] text-gray-900 px-4 py-2 rounded-full text-sm font-bold mb-6 animate-pulse">
                ...
                <span className="text-center">Limited Time:<br className="sm:hidden" /> FREE AI Assessment Worth ₹999</span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start mb-8">
                ...
                <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow-md">
                  ...
                  <span className="font-semibold text-gray-700">500+ Kids Transformed</span>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto items-stretch">
            ...
            <div className="bg-white rounded-3xl p-8 border-2 border-gray-200 hover:border-[#00abff] hover:shadow-xl transition-all flex flex-col">
              ...
              <div className="text-4xl font-black text-gray-900 mb-6">
                ₹0 <span className="text-lg font-medium text-gray-400 line-through">₹999</span>
              </div>
            ...
            <div className="bg-gradient-to-br from-[#ff0099] to-[#7b008b] rounded-3xl p-8 text-white relative overflow-hidden flex flex-col">
              ...
              <div className="mb-6">
                <span className="text-5xl font-black">₹5,999</span>
                <span className="text-xl font-medium text-white/60 line-through ml-2">₹9,999</span>
      ...
      <section className="py-16 lg:py-24 bg-[#f5f5f5]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                quote: "My daughter went from hating reading to asking for bedtime stories every night. The transformation in 3 months was unbelievable!",
                name: "Priya Mehta",
                child: "Mother of Ananya, 7",
                rating: 5,
              },
              {
                quote: "Vedant AI pinpointed exactly where my son was struggling. The personalized coaching fixed issues his school couldn't identify.",
                name: "Rahul Sharma",
                child: "Father of Arjun, 9",
                rating: 5,
              },
              {
                quote: "Worth every rupee! My child improved 2 grade levels in reading. The coaches are patient and the progress tracking is excellent.",
                name: "Sneha Patel",
                child: "Mother of Vihaan, 6",
                rating: 5,
              },
              ...
              <div key={index} className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm">{testimonial.child}</p>
                </div>
              </div>
            ))}
          </div>
