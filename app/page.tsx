...
async function getHomePageData() {
  try {
    ...
    const content = {
      ...
      hero_badge_curiosity: settings.hero_badge_curiosity as string || 'rAI-Powered Reading Analysis',
      hero_badge_validation: settings.hero_badge_validation as string || 'For Ages 4-12 • AI + Expert Coaches',
      ...
      hero_trust_badge_1: settings.hero_trust_badge_1 as string || '100% Free',
      hero_trust_badge_2: settings.hero_trust_badge_2 as string || '5 Minutes',
      hero_trust_badge_3: settings.hero_trust_badge_3 as string || 'Instant Results',
      ...
      // ARC section
      arc_section_badge: settings.arc_section_badge as string || 'THE YESTORYD ARC™',
      ...
      arc_promise_badge_1: settings.arc_promise_badge_1 as string || 'Measurable Growth',
      arc_promise_badge_2: settings.arc_promise_badge_2 as string || '100% Refund Guarantee',
      arc_promise_badge_3: settings.arc_promise_badge_3 as string || 'Full Transparency',
      ...
      // FAQ section
      faq_section_badge: settings.faq_section_badge as string || 'Common Questions',
      ...
      // Story section
      story_section_badge: settings.story_section_badge as string || 'THE YESTORYD STORY',
      ...
      // rAI section
      rai_section_badge: settings.rai_section_badge as string || 'Meet rAI',
      ...
      testimonials_section_badge: settings.testimonials_section_badge as string || 'Real Results',
      ...
      // Journey section
      journey_section_badge: settings.journey_section_badge as string || 'The Complete Journey',
      ...
      // Pricing section
      pricing_section_badge: settings.pricing_section_badge as string || 'Start Your ARC Journey',
      ...
      pricing_free_badge: settings.pricing_free_badge as string || 'Step 1 — Start Here',
      ...
      pricing_step2_badge: settings.pricing_step2_badge as string || 'Step 2 — Choose Your Program',
